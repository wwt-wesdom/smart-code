  ...
  <div class="fs-12 basic-setting">
    <el-form label-width="120px" :model="item" ref="basicForm">
      ...
      <el-form-item label="宽/高">
        <el-input :disabled="widthDisabled" type="number" @input.native="widthChange" v-model.number="item.width"
                  width="100px">
          <template slot="append">px</template>
        </el-input>
        <el-input :disabled="heightDisabled" class="ml10" type="number" @input.native="heightChange"
